...
namespace mad {
    ...
    circular_buffer_base::circular_buffer_base(circular_buffer_base&& mv) = default;
    circular_buffer_base& circular_buffer_base::operator=(circular_buffer_base&& mv) = default;
}
