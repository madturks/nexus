...
TEST(RandomTest, FillSpanWithValueRange) {
    ...
    for (const auto & val : vec) {
        ASSERT_NE(std::find(value_range.begin(), value_range.end(), val),
                  value_range.end());
    }
}
...
TEST(RandomTest, FillSpanWithLargeValueRange) {
    ...
    std::span vec_span{ vec };
    std::iota(value_range.begin(), value_range.end(),
              1); // Fill value_range with values from 1 to 100
    mad::random::fill_span<int>(vec_span, value_range);
...
TEST(RandomTest, FillSpanWithCharBoundaryEdgeCases) {
    ...
    std::span vec_span{ vec };
    mad::random::arithmetic_boundary<char> bounds{
...
TEST(RandomTest, FillSpanWithInt8BoundaryEdgeCases) {
    ...
    std::span vec_span{ vec };
    mad::random::arithmetic_boundary<int8_t> bounds{
...
TEST(RandomTest, FillSpanWithInt16BoundaryEdgeCases) {
    ...
    std::span vec_span{ vec };
    mad::random::arithmetic_boundary<int16_t> bounds{
...
TEST(RandomTest, FillSpanWithInt32BoundaryEdgeCases) {
    ...
    std::span vec_span{ vec };
    mad::random::arithmetic_boundary<int32_t> bounds{
...
TEST(RandomTest, FillSpanWithInt64BoundaryEdgeCases) {
    ...
    std::span vec_span{ vec };
    mad::random::arithmetic_boundary<int64_t> bounds{
...
TEST(RandomTest, FillSpanWithUInt8BoundaryEdgeCases) {
    ...
    std::span vec_span{ vec };
    mad::random::arithmetic_boundary<uint8_t> bounds{
...
TEST(RandomTest, FillSpanWithUInt16BoundaryEdgeCases) {
    ...
    std::span vec_span{ vec };
    mad::random::arithmetic_boundary<uint16_t> bounds{
...
TEST(RandomTest, FillSpanWithUInt32BoundaryEdgeCases) {
    ...
    std::span vec_span{ vec };
    mad::random::arithmetic_boundary<uint32_t> bounds{
...
TEST(RandomTest, FillSpanWithUInt64BoundaryEdgeCases) {
    ...
    std::span vec_span{ vec };
    mad::random::arithmetic_boundary<uint64_t> bounds{
...
TEST(RandomTest, FillSpanWithFloatBoundaryEdgeCases) {
    ...
    std::span vec_span{ vec };
    // regarding max/2 see:
    // https://timsong-cpp.github.io/cppwp/rand.dist.uni.real#2
    mad::random::arithmetic_boundary<float> bounds{
...
TEST(RandomTest, FillSpanWithDoubleBoundaryEdgeCases) {
    ...
    // regarding max/2 see:
    // https://timsong-cpp.github.io/cppwp/rand.dist.uni.real#2
    mad::random::arithmetic_boundary<double> bounds{
