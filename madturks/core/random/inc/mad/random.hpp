...
namespace mad::random {
     ...
     *
     * @param [in,out] span Contiguous range of elements to fill
     * @param [in] value_range Value range which elements of span will be randomly selected from
     *
     */
    template <typename T>
...
extern template auto mad::random::fill_span(std::span<std::int8_t> & span, mad::random::arithmetic_boundary<std::int8_t> bounds) -> void;
extern template auto mad::random::fill_span(std::span<std::int16_t> & span, mad::random::arithmetic_boundary<std::int16_t> bounds) -> void;
extern template auto mad::random::fill_span(std::span<std::int32_t> & span, mad::random::arithmetic_boundary<std::int32_t> bounds) -> void;
extern template auto mad::random::fill_span(std::span<std::int64_t> & span, mad::random::arithmetic_boundary<std::int64_t> bounds) -> void;
extern template auto mad::random::fill_span(std::span<std::uint8_t> & span, mad::random::arithmetic_boundary<std::uint8_t> bounds) -> void;
extern template auto mad::random::fill_span(std::span<std::uint16_t> & span, mad::random::arithmetic_boundary<std::uint16_t> bounds) -> void;
extern template auto mad::random::fill_span(std::span<std::uint32_t> & span, mad::random::arithmetic_boundary<std::uint32_t> bounds) -> void;
extern template auto mad::random::fill_span(std::span<std::uint64_t> & span, mad::random::arithmetic_boundary<std::uint64_t> bounds) -> void;
